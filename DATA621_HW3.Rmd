...
Given the boxplot below, the variable `chas` has few outliers.
...
crime_training_data %>%
  ...
  theme_minimal()
```
Based on the correlation plot, it shows that `rad` and `tax` have the highest positive correlation compared to other variables.

```{r cor_plot, warning=FALSE, message=FALSE}
