...
With data explored and prepped, 4 models will be build.

### Model 1

The first model is based on the original training data set and will help define the baseline.
...
To determine the best model, many applications will be used including F-1 score, ROC curve, accuracy, and confusion matrix.
